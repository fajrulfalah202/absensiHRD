...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('Karyawan-dashboard')}}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span></a>
            </li>
            <!-- Nav Item - Presensi -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('Karyawan-Presensi')}}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Presensi</span></a>
            </li>
            <!-- Nav Item - Laporan Kehadiran -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('Karyawan-LaporanKehadiran') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Laporan Kehadiran</span></a>
            </li>
            {{-- keterlambatan --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/Karyawan-LaporanKehadiran-terlambat') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Laporan Keterlambatan</span></a>
            </li>
            {{-- lembur --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/Karyawan-LaporanKehadiran-lembur') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Laporan Lembur</span></a><!-- Divider -->
