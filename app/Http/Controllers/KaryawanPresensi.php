...
class KaryawanPresensi extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $dataPresensi = Presensi::where('id_user', $user->id_user)
            ...
            return view('karyawan.presensi.index',compact('dataKaryawan','canPresensi','sudahMasuk','sudahkeluar','dataPresensi' ) );
    }
    public function presensiMasuk(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Presensi masuk berhasil buat karyawan!');
    }
