...
class superAdminPresensi extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $dataPresensi = Presensi::where('id_user', $user->id_user)
            ...
            return view('super_admin.presensi.index',compact('dataKaryawan','canPresensi','sudahMasuk','sudahkeluar','dataPresensi' ) );
    }
